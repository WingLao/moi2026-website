...
|任務名稱|`f5b-17-two-sum`|
|組別|`Beginner`|
|測資目錄|`data/Beginner/f5b-17-two-sum`|
|來源|`F5B_2025_2026_20260416.ipynb`|
|對齊範例|`f5b-17-two-sum-0.in` / `f5b-17-two-sum-0.out`|

## 題目說明

Input a list of integers and a target. Print two indices such that the two numbers add up to the target.
